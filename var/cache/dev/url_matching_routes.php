    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .'|/admin/formation/([^/]++)(?'
                    .'|(*:197)'
                .')'
                .'|/categorie/([a-z0-9\\-]*)\\-([^/]++)(*:240)'
                .'|/formations/([a-z0-9\\-]*)\\-([^/]++)(*:283)'
            .')/?$}sDu',
    ],
    [ // $dynamicRoutes
        ...
        240 => [[['_route' => 'categorie.show', '_controller' => 'App\\Controller\\CategorieController::show'], ['slug', 'id'], null, null, false, true, null]],
        283 => [
